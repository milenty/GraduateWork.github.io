...
const searchFormButton = document.querySelector(".search__form_button");
...
const newsCardList = new NewsCardList(newsListCards,dataStorage,createCard);
const searchInput = new SearchInput(newsApi, searchFormButton, searchFormInput, newsCardList.startPreloader.bind(newsCardList), newsCardList.stopPreloader.bind(newsCardList), dataStorage);
