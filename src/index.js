...
const newsApi = new NewsApi( {
    ...
    pageSize: '100'//,
    //from: getRequestFormattedDate(), // 7 дней от текущей даты, написать функции
    //to: getRequestFormattedDate() //текущая дата
});*/

/*const searchInput = new SearchInput(newsApi, searchFormButton, searchFormInput, test1,test2);
